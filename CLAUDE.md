...
Portable coding rules and standards live in [AGENTS.md](AGENTS.md). Read that
first — this file only carries the ntrip-specific project knowledge that
`AGENTS.md` doesn't cover.
